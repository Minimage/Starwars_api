...
export const PlanetPage = () => {
  ...
  return (
    <div className="container">
      ...
      <h1>Planet Page {planet !== null ? planet.rotation_period : ""}</h1>
    </div>
</div>
</div>
</div>
    ...
    // //     <div className="row">
    // //       <div className="col-6 left">
    // //         <img className={planet.name != undefined ? 'show' : "hide"} src={links} ></img>
    ...
    // //         <p className={planet.name != undefined ? 'show' : "hide"}> 
    ...
    // //         <h3 className="item"> {planet.name !== null ? planet.name : ""}</h3>
    // //       </div>
    // //       <div className="col-2">
    // //         <h3 className="item"> Rotation Period</h3>
    // //         <h3 className="item"> {planet.rotation_period !== "null" ? planet.rotation_period : ""}</h3>
    // //       </div>
    // //       <div className="col-2">
